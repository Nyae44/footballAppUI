...
object FixtureRepository {
    val matchFixtures = listOf<Fixture>(
        ...
        Fixture(R.string.man_city,R.drawable.manchester_city_emblem,R.string.time_2,R.string.brighton,R.drawable.brighton),
        Fixture(R.string.wolves,R.drawable.wolves_logo,R.string.time_3,R.string.leicester,R.drawable.leicester)
    )
}